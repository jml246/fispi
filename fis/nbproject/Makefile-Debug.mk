...
${OBJECTDIR}/_ext/157685732/LED0_OFF.o: ../wiringPi/fisled/led/LED0_OFF.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED0_OFF.o ../wiringPi/fisled/led/LED0_OFF.c

${OBJECTDIR}/_ext/157685732/LED3_ON.o: ../wiringPi/fisled/led/LED3_ON.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED3_ON.o ../wiringPi/fisled/led/LED3_ON.c

${OBJECTDIR}/_ext/157685732/LED1_OFF.o: ../wiringPi/fisled/led/LED1_OFF.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED1_OFF.o ../wiringPi/fisled/led/LED1_OFF.c

${OBJECTDIR}/_ext/157685732/LED2_ON.o: ../wiringPi/fisled/led/LED2_ON.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED2_ON.o ../wiringPi/fisled/led/LED2_ON.c

${OBJECTDIR}/testing/fis_test.o: testing/fis_test.c 
	${MKDIR} -p ${OBJECTDIR}/testing
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/testing/fis_test.o testing/fis_test.c

${OBJECTDIR}/_ext/157685732/LED3_OFF.o: ../wiringPi/fisled/led/LED3_OFF.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED3_OFF.o ../wiringPi/fisled/led/LED3_OFF.c

${OBJECTDIR}/fis_post_proc.o: fis_post_proc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fis_post_proc.o fis_post_proc.c

${OBJECTDIR}/_ext/157685732/LED2_OFF.o: ../wiringPi/fisled/led/LED2_OFF.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED2_OFF.o ../wiringPi/fisled/led/LED2_OFF.c

${OBJECTDIR}/fis.o: fis.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fis.o fis.c

${OBJECTDIR}/_ext/1601161056/wiringPi.o: ../wiringPi/fisled/wiringPi.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1601161056
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1601161056/wiringPi.o ../wiringPi/fisled/wiringPi.c

${OBJECTDIR}/_ext/157685732/LED0_ON.o: ../wiringPi/fisled/led/LED0_ON.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED0_ON.o ../wiringPi/fisled/led/LED0_ON.c

${OBJECTDIR}/_ext/157685732/LED1_ON.o: ../wiringPi/fisled/led/LED1_ON.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/157685732
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/157685732/LED1_ON.o ../wiringPi/fisled/led/LED1_ON.c
